...
import com.inn.shop.service.ProductService;
            ...
            if(jwtFilter.isAdmin()){
                if(validateProductMap(requestMap, true)){
                    ...
                    if(!optional.isEmpty()){
                        ...
                        return ShopUtils.getResponseEntity("Product Updated Succsesfuly", HttpStatus.OK);
                    }else{
        ...
        try{
            if(jwtFilter.isAdmin()){
                ...
                if(!optional.isEmpty()){
                    ...
                    return ShopUtils.getResponseEntity("Product Deleted Successfoully", HttpStatus.OK);
                }
                return ShopUtils.getResponseEntity("Product id does not exist.", HttpStatus.OK);
            }else{
                return ShopUtils.getResponseEntity(ShopConstants.UNAUTHORIZED_ACCESS, HttpStatus.UNAUTHORIZED);
